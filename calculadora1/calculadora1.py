...
def calculadora():
    ...
    if seleccion == '1':
        ...
        print(
            f"La suma de {valor_a} y {valor_b} es "
        ...
        resultado = valor_a - valor_b
        print(
            f"La resta de {valor_a} y {valor_b} es "
            f"{formatear_resultado(resultado)}"
        )
        ...
        resultado = valor_a * valor_b
        print(
            f"La multiplicación de {valor_a} y {valor_b} es "
            f"{formatear_resultado(resultado)}"
        )
        ...
        if valor_b != 0:
            resultado = valor_a / valor_b
            print(
                f"La división de {valor_a} entre {valor_b} es "
                f"{formatear_resultado(resultado)}"
            )
        else:
